...
export LR="1.6e-4"
export OUTPUT_DIR="/checkpoint/memorization/chuanguo/meta-llama/${MODEL}_dpo_${ATTACK}_randpos_${RESPONSE}_${DATASET}_ns${NUM_SAMPLES}_bs256_${LR}_maxlength1024_nomlp"
