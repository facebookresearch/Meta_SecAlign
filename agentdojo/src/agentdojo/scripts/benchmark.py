...
def benchmark_suite(
    ...
    pi_detector_threshold: float | None = None,
    ...
    pipeline = AgentPipeline.from_config(
        PipelineConfig(
            ...
            model_id=model_id,
            defense=defense,
            pi_detector_threshold=pi_detector_threshold,
...
@click.option(
    "--pi-detector-threshold",
    type=float,
    default=0.9,
    help="Prompt injection detection threshold for transforemrs-pi-detector defense.",
)
@click.option(
    "--tool-delimiter",
    type=str,
