...
if torch.cuda.device_count():
    ...
    #generate_preference_dataset('meta-llama/Llama-3.1-8B-Instruct', instruct_dataset="natural", self_generated_response=False, random_inject_pos=False, random_conversation_turn=False)
