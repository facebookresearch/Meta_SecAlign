...
if torch.cuda.device_count() >= 4: 
    ...
    #generate_preference_dataset('meta-llama/Llama-3.3-70B-Instruct', instruct_dataset="alpaca", self_generated_response=True, random_inject_pos=False)
    #generate_preference_dataset('meta-llama/Llama-3.3-70B-Instruct', instruct_dataset="alpaca", self_generated_response=False, random_inject_pos=True)
    #generate_preference_dataset('meta-llama/Llama-3.3-70B-Instruct', instruct_dataset="alpaca", self_generated_response=False, random_inject_pos=False)
    #generate_preference_dataset('meta-llama/Llama-3.3-70B-Instruct', instruct_dataset="natural", self_generated_response=False, random_inject_pos=False)
    #generate_preference_dataset('meta-llama/Llama-3.1-70B-Instruct', instruct_dataset="alpaca", self_generated_response=True, random_inject_pos=True)
...
else: print('Skipping Llama-3.1-8B-Instruct preference dataset generation due to no available GPUs.')
